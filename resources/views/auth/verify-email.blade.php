...
<head>
    ...
    <title>Verificar Correo - Eunoia</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-logout:hover { color: var(--cherry); }
    </style>
</head>
<body>
    ...
    <div class="card">
        ...
        <div class="brand">
            ...
            <div class="brand-sub">Verifica tu correo</div>
            <div class="brand-line"></div>
        </div>

        <p class="description">
            ¡Gracias por registrarte! Antes de continuar, verifica tu dirección de correo haciendo clic en el enlace que te enviamos. Si no lo recibiste, con gusto te enviamos otro.
        </p>
